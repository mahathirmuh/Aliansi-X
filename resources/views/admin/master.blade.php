        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="{{asset('images-profile-picture/'.Auth::user()->profile_photo)}}" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="{{asset('images-profile-picture/'.Auth::user()->profile_photo)}}" class="img-circle" alt="User Image">
              ...
              <li class="user-footer">
                <div class="pull-right">
                  <a href="{{url('admin/user-info-edit/'.Auth::user()->id)}}" class="btn btn-default btn-flat">Profile</a>
                </div>
              </li>
            </ul>
          </li>
