      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 text-lg-left">
            <img src="{{asset('images-kegiatan-desa/'.$Activity->thumbnail)}}" width="250px" height="140">
          </div>
          <div class="col-lg-6 text-center text-lg-left">
            <h3 class="cta-title">{{$Activity->title}}</h3>
            <p class="cta-text">{{str_limit($Activity->description,200)}}</p>
          </div>
          <div class="col-lg-3 cta-btn-container text-center">
            <a class="cta-btn align-middle" href="{{url('artikel/'.$Activity->id)}}">Lihat Selengkapnya . . .</a>
          </div>
          @endforeach
        </div>
      </div>
    </section>
      <span class="pull-right" style="font-size: 30px">{{$activities->links()}}</span><!-- #call-to-action -->
